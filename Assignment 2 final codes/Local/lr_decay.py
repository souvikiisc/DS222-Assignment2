...
#x_train=np.zeros((t2.shape[0]+t1.shape[0],t1.shape[1]))
#x_train[0:t1.shape[0],:]=t1[:,:]
#x_train[t1.shape[0]:,:]=t2[:,:]
#t1=0
#t2=0
...
learning_rate = tf.train.exponential_decay(starter_learning_rate, global_step,
                                           total_batch, 0.96, staircase=True)
